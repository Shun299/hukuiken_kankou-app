...
// 中分類と小分類の対応表
const categoryMap = {
    '歴史・文化': ['史跡', '神社・仏閣', '庭園', '動・植物園' , '水族館', '博物館', '美術館', '記念・資料館', '歴史的まち並み、旧街道', '産業観光', '城'],
    '自然（行祭事・イベント）': ['海岸', '山岳', '河川', '高原', '湖沼', 'その他自然'],
    '温泉・健康': ['温泉地'],
    'ｽﾎﾟｰﾂ･ﾚｸﾘｴｰｼｮﾝ': ['海水浴場', 'スポーツ・レクリエーション施設', '釣り場', 'キャンプ場', 'スキー場', '公園', 'レジャーランド・遊園地', 'テーマパークテーマパーク'],
    '都市型観光 買物 食': ['地区・商店街', '食・グルメ', 'その他都市型観光－買物・食等－'],
    'その他': ['他に分類されない観光地点']
};
